...
Most commonly, we try to identify b-quarks. This is partically because physics involving b-quarks is all-the-rage these days, and partially because jets coming from b-quarks, or **b-jets**, are easy to identify!
...
I'll give you the tracks of 18 different jets, each a b-jet or a non-b-jet. Assign each jet a b-tagging score of 1-5, using a larger score to mean "more b-like".
