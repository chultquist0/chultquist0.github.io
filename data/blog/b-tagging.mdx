...
If you want some context for what all of that means, read the section below. If you either don't need or don't care, [skip ahead](#thetest), but at least pause and look at my drawings along the way!
...
This **secondary vertex** is a big name-tag saying "Hello! I'm A B-JET". Other jets (often c-jets, or jets from c-quarks) have a secondary vertex as well, but it is much closer to the primary vertex.
...
<div className="flex flex-col items-start gap-5 md:flex-row">
  <img src="/static/images/3197_ex/3197_b_uncropped2.png" alt="Alt text" width="300" />
  <div>
    <p>
      <font color="blue">
        <b>Blue</b>
      </font>{' '}
      tracks represent that paths of positively charged particles, while{' '}
      <font color="green">
        <b>green</b>
      </font>{' '}
      are negatively charged. Neutral particles don't leave tracks, so they aren't shown here.
...
<div className="flex flex-col items-start gap-5 md:flex-row">
  <img src="/static/images/3197_ex/3197_b_uncropped.png" alt="Alt text" width="320" />
  <img src="/static/images/3197_ex/3197_b_cropped.png" alt="Alt text" width="320" />
</div>
...
<div className="flex justify-center">
  <img src="/static/images/3197_ex/GN2.png" alt="Alt text" width="450" />
</div>
